...
public class FragmentOSBusinessId extends Fragment 
{
	private Context app_context ;
	private Activity app_activity;
	private FragmentOSBusinessId this_class;
	...
	private TextView new_business_serial_text_view ;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) 
    {
    	...
    	current_view = inflater.inflate(R.layout.fragment_os_business_id, container, false);
    	
    	((ImageView) findViewById(R.id.title_bar_main_title)).setBackgroundResource(R.drawable.title_bar_os_business_id);
		...
		setting = app_activity.getSharedPreferences("remember", Context.MODE_PRIVATE );
        ...
        new_business_serial_text_view = (TextView) findViewById(R.id.new_business_serial);
        
        apply_user_text_view = (TextView) findViewById(R.id.apply_user);
        apply_user_text_view.setOnFocusChangeListener(on_focuse_change_listener);
		...
		/*
		LinearLayout scroll_content = (LinearLayout) findViewById(R.id.not_menu_bar);
		
		for(int i = 0 ; i < scroll_content.getChildCount() ; i++ )
		{
			View view = scroll_content.getChildAt(i);
			...
			if( view instanceof EditText)
			{
				view.setOnFocusChangeListener(new OnFocusChangeListener()
				{
					...
					public void onFocusChange(View v, boolean hasFocus) 
					{
						...
						if( !hasFocus )
							 ((TextView) v).setText( ASaBuLuCheck.convertNumberType( ((TextView) v).getText().toString() , ASaBuLuCheck.HALF_TYPE) );
					}
    ...
    private OnFocusChangeListener on_focuse_change_listener = new OnFocusChangeListener()
    {
    ...
    private OnClickListener on_click_listener = new OnClickListener()
    {
    	...
    	public void onClick(View v)
    	{
    		...
    		if( v.getId() == R.id.title_bar_menu_button )
    		{
    			...
    			String new_business_serial = new_business_serial_text_view.getText().toString();
				...
				//View this_view = app_activity.findViewById(android.R.id.content).getRootView(); //replace by Activity.findViewbyId();
        		...
        		if( new_business_serial.isEmpty() || new_business_serial.length() > 9 || !ASaBuLuCheck.idCheck(new_business_serial) )
        		{	
        			error_message += "統一編號未填或錯誤\n";
        			
        			error_layout_id.add(Integer.valueOf(R.id.new_business_serial_layout));
        			error_mark_id.add(Integer.valueOf(R.id.new_business_serial_error_mark));
        		}
        		...
        		else
        		{
					...
					String url = "http://wapp.taipower.com.tw/newnas/nawp051.aspx";
    ...
    private OnItemSelectedListener on_item_selected_listener = new OnItemSelectedListener()
    {
		...
		{
			// TODO Auto-generated method stub
			Toast.makeText(app_context, "沒有選到東西" , Toast.LENGTH_SHORT ).show();
		}
    };
	...
	private class LoadingDataAsyncTask extends AsyncTask<String, Integer, Integer> 
    {
        ...
        protected void onPostExecute(Integer result) 
        {
			...
			if( result.intValue() == 0 && response_data != null )
			{
	...
	private OnClickListener send_on_click_listener = new OnClickListener()
	{
		...
		public void onClick(View v) 
		{
			...
			if( v.getTag().equals("check") )
			{
    	        ...
    	        String url = "http://wapp.taipower.com.tw/newnas/nawp052.aspx";
