 ...
 */
public class gcm_service extends Activity 
{
	private Context app_context;
	private Activity app_activity;
	
    public static String electric_number;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gcm_service);
        ...
        {	
			...
			final String regId = GCMRegistrar.getRegistrationId(gcm_service.this);
        
			if (regId.equals("")) 
			{
				//Automatically registers application on startup.
				Log.d("GCM", "尚未註冊 Google GCM, 進行註冊");
				GCMRegistrar.register(gcm_service.this, SENDER_ID );
			} 
			else 
			{
				...
				if (GCMRegistrar.isRegisteredOnServer(gcm_service.this)) 
				{
					// Skips registration.
				...
				else 
				{
					...
					final Context context = gcm_service.this;
        ...
        unregistered.setOnClickListener( new View.OnClickListener() 
        {
			...
			{
				// TODO Auto-generated method stub
				String regId = GCMRegistrar.getRegistrationId(gcm_service.this);
				
				GCMRegistrar.unregister(gcm_service.this );
