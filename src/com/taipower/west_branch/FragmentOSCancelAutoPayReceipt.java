...
import com.taipower.west_branch.FragmentOSCancelAutoPay.LoadingDataAsyncTask;
...
public class FragmentOSCancelAutoPayReceipt extends Fragment 
{
	
	private Context app_context ;
	private Activity app_activity ;
	private FragmentOSCancelAutoPayReceipt this_class;
	...
	public FragmentOSCancelAutoPayReceipt()
	{
	...
	public View onCreateView(LayoutInflater inflater,ViewGroup root, Bundle savedInstanceState) 
    {
        ...
        current_view = inflater.inflate(R.layout.fragment_os_cancel_auto_pay_receipt, root, false);
        
        ((ImageView) findViewById(R.id.title_bar_main_title)).setBackgroundResource(R.drawable.title_bar_os_cancel_auto_pay_receipt);
        ...
        ArrayAdapter adapter_action = new ArrayAdapter(app_context,android.R.layout.simple_spinner_item,new String[]{"停止印寄 ","恢復印寄"});
    	...
    	public void onClick(View v) 
    	{
    		...
    		if( v.getId() == R.id.title_bar_menu_button)
    		{
        		...
        		else
        		{
					...
					String url = "http://wapp.taipower.com.tw/newnas/nawp1w2.aspx";
		...
		public void onClick(View v) 
		{
			...
			if( v.getTag().equals("check") )
			{
	    		...
	    		catch (UnsupportedEncodingException e) 
	    		{
	   	        ...
	   	        String url = "http://wapp.taipower.com.tw/newnas/nawp1w3.aspx";
    ...
    {
    	String url = "http://wapp.taipower.com.tw/newnas/nawp1w1.aspx";
