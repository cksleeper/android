...
public class FragmentOSMeterCheck extends Fragment 
{
	private Context app_context;
	private Activity app_activity;
	private FragmentOSMeterCheck this_class;
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup root, Bundle savedInstanceState) 
    {
    	...
    	current_view = inflater.inflate(R.layout.fragment_os_meter_check, root, false);
        
    	((ImageView) findViewById(R.id.title_bar_main_title)).setBackgroundResource(R.drawable.title_bar_os_meter_check);
        ...
        ArrayAdapter adapter_action = new ArrayAdapter(app_context,android.R.layout.simple_spinner_item,new String[]{"屋內線檢驗","電表勘驗"});
    	...
    	public void onClick(View v) 
    	{
    		...
    		if( v.getId() == R.id.title_bar_menu_button)
    		{
        		...
        		else
        		{
					...
					String url = "http://wapp.taipower.com.tw/newnas/nawp061.aspx";
	...
	class LoadingDataAsyncTask extends AsyncTask<String, Integer, Integer> 
    {
		...
		private OnClickListener send_on_click_listener = new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				...
				if( v.getTag().equals("check") )
				{
	    	        ...
	    	        String url = "http://wapp.taipower.com.tw/newnas/nawp062.aspx";
	    ...
	    {
	    	String url = "http://wapp.taipower.com.tw/newnas/nawp060.aspx";
