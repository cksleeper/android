...
public class FragmentOSFinance extends Fragment 
{
	private Context app_context;
	private Activity app_activity;
	private FragmentOSFinance this_class;
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup root, Bundle savedInstanceState) 
    {
    	...
    	current_view = inflater.inflate(R.layout.fragment_os_finance, root, false);
        
    	((ImageView) findViewById(R.id.title_bar_main_title)).setBackgroundResource(R.drawable.title_bar_os_finance);
        ...
        ArrayAdapter adapter_action = new ArrayAdapter(app_context ,android.R.layout.simple_spinner_item,new String[]{"營業","非營業"});
    	...
    	public void onClick(View v) 
    	{
    		...
    		if( v.getId() == R.id.title_bar_menu_button)
    		{
        		...
        		else
        		{
					...
					String url = "http://wapp.taipower.com.tw/newnas/nawp041.aspx";
	...
	class LoadingDataAsyncTask extends AsyncTask<String, Integer, Integer> 
    {
		...
		private OnClickListener send_on_click_listener = new OnClickListener()
		{
			...
			public void onClick(View v) 
			{
				...
				if( v.getTag().equals("check") )
				{
	    	        ...
	    	        String url = "http://wapp.taipower.com.tw/newnas/nawp042.aspx";
	    ...
	    {
	    	String url = "http://wapp.taipower.com.tw/newnas/nawp040.aspx";
