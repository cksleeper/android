...
public class ImageMatrix 
{
	...
	//public ImageMatrix(DisplayMetrics dm,ImageView imageView,Bitmap bitmap, ImageButton zoomInButton, ImageButton zoomOutButton)
	public ImageMatrix(DisplayMetrics dm,ImageView imageView,Bitmap bitmap)
	{
		this.dm = dm;
			...
			public boolean onTouch(View arg0, MotionEvent event) 
			{
				switch (event.getAction() & MotionEvent.ACTION_MASK) 
				{
					...
					case MotionEvent.ACTION_MOVE:
						...
						{
							double newDist = spacing(event);//偵測兩根手指移動的距離
							if (newDist > 10f) 
							{
								matrix.set(savedMatrix);
